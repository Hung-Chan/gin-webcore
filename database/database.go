...
func runMigrate(db *gorm.DB) {
	...
	if !db.HasTable(&admingroups.AdminGroup{}) {
		...
		adminGroup := admingroups.AdminGroup{
			Name:       "最高權限使用者",
			Permission: `{"admin":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"adminGroup":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"adminLevel":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"adminAccess":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"ipWhitelisting":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"ipSubnetWhitelisting":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"areaBlacklisting":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"menuGroup":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true},"menuSetting":{"enable":true,"view":true,"create":true,"edit":true,"copy":true,"delete":true}}`,
			Remark:     "",
			Enable:     1,
		}
